...
Getting the data:
```{r}
download.file("https://data.cityofnewyork.us/api/views/833y-fsy8/rows.csv?accessType=DOWNLOAD", destfile = "shooting_data.csv")
shootings_data <- readr::read_csv("shooting_data.csv")
```
